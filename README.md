...
1. Open [main.ipynb](main.ipynb) and run all cells to regenerate the cleaned datasets.
2. Use [web-app-prep.ipynb](web-app-prep.ipynb) to shape outputs for UI consumption.
3. Optionally run the SQL scripts to load a local database for demos or API work.
